...
const required = [
  ...
  ['speech synthesis utterance', /SpeechSynthesisUtterance/],
...
if (!/SpeechSynthesisUtterance/.test(component)) throw new Error('Audio interview regression: questions are no longer spoken');
...
console.log('Audio interview contract verified: speech synthesis, accessibility and cleanup are present.');
